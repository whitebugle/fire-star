...
import com.example.bean.DauInfo
import com.example.util.{MyESUtil, MyKafkaUtil, MyRedisUtil, OffsetManagerUtil}
...
object DauApp {
  ...
  def main(args: Array[String]): Unit = {
    ...
    var topic:String = "gmall_start_00"
    var groupId:String = "gmall_dau_2021"

    //从Redis中获取Kafka分区偏移量
        val offsetMap: Map[TopicPartition, Long] = OffsetManagerUtil.getOffset(topic,groupId)
//        val offsetMap: Map[TopicPartition, Long] = null

    var recordDStream: InputDStream[ConsumerRecord[String, String]] = null

    //使用工具类 指定消费组 从kafka 获取数据
    ...
    val jsonObjDStream: DStream[JSONObject] = offsetDStream.map {
      record => {
        ...
        //从json对象中获取时间戳
        val ts: java.lang.Long = jsonObject.getLong("ts")
        //将时间戳转换为日期和小时  2021-6-21 16
    ...
    /*
        ...
        //redis 类型 set    key：  dau：2021-6-21    value: mid    expire   3600*24
